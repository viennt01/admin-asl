...
export default function EditPricingTrucking() {
  ...
  const columnsTransHis: ColumnsType<DataType> = [
    ...
    {
      title: translateBooking('name_PricingTrucking'),
      dataIndex: 'namePricingTrucking',
      align: 'center',
    },
    {
        ...
        >
          <Card style={{ marginBottom: 24 }}>
            <Row justify={'center'}>
              <Col>
                <Title level={3}>
                  {translatePricingTrucking('information_edit_PricingTrucking')}
                </Title>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col lg={5} span={24}>
                <Form.Item
                  label={translatePricingTrucking('code')}
                  name="code_PricingTrucking"
                  rules={[
                    {
                      required: true,
                      message: 'Please input type of code PricingTrucking',
                    },
                  ]}
                >
                  <Input placeholder="Nhập mã PricingTrucking" />
                </Form.Item>
              </Col>
              ...
              <Col lg={12} span={24}>
                <Form.Item
                  ...
                  name="name_PricingTrucking"
                  rules={[
                    {
                      required: true,
                      message: 'Please input PricingTrucking Name',
                    },
                  ]}
                >
                  <Input placeholder="Nhập tên PricingTrucking" />
                </Form.Item>
              </Col>
              ...
              <Col lg={7} span={24}>
                <Form.Item
                  ...
                  name="abbreviation_PricingTrucking"
                  rules={[
                    {
                      required: true,
                      message: 'Please input Abbreviation of PricingTrucking',
                    },
                  ]}
                >
                  <Input placeholder="Please input Abbreviation of PricingTrucking" />
                </Form.Item>
              </Col>
