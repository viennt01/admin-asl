...
export default function EditCustomerOnSales() {
        ...
        >
          <Card style={{ marginBottom: 24 }}>
            <Row justify={'center'}>
              <Col>
                <Title level={3}>
                  {translateCustomerOnSales('information_edit_customer')}
                </Title>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col lg={5} span={24}>
                <Form.Item
                  label={translateCustomerOnSales('code')}
                  name="code_customer"
                  rules={[
                    {
                      required: true,
              ...
              <Col lg={3} span={24}>
                <Form.Item
                  label={translateCustomerOnSales('date_created')}
                  name="dateCreated"
                  rules={[
              ...
              <Col lg={6} span={24}>
                <Form.Item
                  label={translateCustomerOnSales('creator')}
                  name="creator"
                  rules={[
                    {
                      required: true,
          ...
          >
            <Row gutter={12}>
              <Col>
                <Button onClick={() => router.push(ROUTERS.CUSTOMER_ON_SALES)}>
                  Cancel
                </Button>
              </Col>
              <Col>
