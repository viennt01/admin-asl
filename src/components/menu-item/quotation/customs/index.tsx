...
import CreateCustomsQuotation from './create';
...
export default function CustomsQuotationPage() {
  ...
  const columns: ProColumns<DataType>[] = [
    ...
    {
      title: translateCustomsQuotation('status'),
      width: 150,
      dataIndex: 'status',
      key: 'status',
      align: 'center',
    ...
    },
    {
      title: (
        <div style={{ textTransform: 'uppercase' }}>
          {translateCustomsQuotation('date_created')}
        </div>
      ),
      width: 150,
    ...
    },
    {
      title: (
        <div style={{ textTransform: 'uppercase' }}>
          {translateCustomsQuotation('creator')}
        </div>
      ),
      width: 200,
      dataIndex: 'creator',
  ...
  return (
    <ProTable<DataType>
      ...
      headerTitle={translateCustomsQuotation('title')}
      scroll={{
        x: 'max-content',
      }}
      ...
      toolBarRender={() => [
        <CreateCustomsQuotation key={'create'} />,
        <Button
          icon={<DeleteOutlined />}
          style={{
