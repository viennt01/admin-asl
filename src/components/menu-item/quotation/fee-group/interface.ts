...
export enum TYPE_TABS {
  GET_OTHER_CHARGES_QUOTATION_BY_MASTER_DATA = 'GET_OTHER_CHARGES_QUOTATION_BY_MASTER_DATA',
  GET_OTHER_CHARGES_QUOTATION_BY_REQUEST_DATA = 'GET_OTHER_CHARGES_QUOTATION_BY_REQUEST_DATA',
  GET_OTHER_CHARGES_QUOTATION_BY_DRAFT_DATA = 'GET_OTHER_CHARGES_QUOTATION_BY_DRAFT_DATA',
}
