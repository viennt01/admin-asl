...
import { getBooking } from '../fetcher';
import { IDataHistoryTable, TYPE_SERVICE } from '../../booking/interface';
...
export default function BookingTable() {
  ...
  const completedQuerySearch = useQuery({
    queryKey: ['BOOKING', querySelectParams],
    queryFn: () =>
      getBooking({
        searchAll: querySelectParams,
