    ...
    <>
      <Tabs
        ...
        items={[
          {
            label: 'Master Data',
            key: TYPE_TABS.GET_CUSTOM_PRICING_BY_MASTER_DATA,
            children: <MasterDataTable />,
          },
          {
            label: (
              <Badge
                count={GetTitleNotificationTab(userInfo?.totalCustomsPricing)}
                style={{
                  marginRight: '-4px',
                  marginTop: '-2px',
                }}
              >
                <div
                  style={{
                    color:
                      keyActive === TYPE_TABS.GET_CUSTOM_PRICING_BY_REQUEST_DATA
                        ? COLORS.GREEN
                        : COLORS.BLACK_BLUR,
                  }}
                >
            ...
            key: TYPE_TABS.GET_CUSTOM_PRICING_BY_REQUEST_DATA,
