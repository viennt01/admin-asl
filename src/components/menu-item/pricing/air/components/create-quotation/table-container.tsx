...
import { getAllTypeLoadCapacity } from '@/components/menu-item/quotation/air/fetcher';
import { TYPE_LOAD_CAPACITY } from '@/components/menu-item/quotation/air/interface';
    ...
    onSuccess: (data) => {
      if (!data.status) {
        ...
        const newData = data.data.map((currency) => ({
          key: currency.loadCapacityID,
          containerName: currency.name,
          profitRate: '',
        }));
