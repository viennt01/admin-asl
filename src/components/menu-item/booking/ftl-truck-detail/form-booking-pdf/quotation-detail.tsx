...
export default function QuotationDetail({ dataPropsBooking }: Props) {
  ...
  useEffect(() => {
    setData(
      dataPropsBooking?.truckingQuotationSelected?.truckingQuotationFCLDetails?.map(
        (item, index) => ({
          key: index,
  ...
  useEffect(() => {
    setDataTotalPrice(
      dataPropsBooking?.truckingQuotationSelected?.sumTruckingQuotationFCLDetails?.map(
        (item, index) => ({
          key: index,
