...
export default function OtherCharges({ dataPropsBooking }: Props) {
  ...
  useEffect(() => {
    setData(
      dataPropsBooking?.truckingQuotationSelected?.ortherChargeDetailForBookings?.map(
        (item, index) => ({
          key: index,
  ...
  useEffect(() => {
    setDataTotalPrice(
      dataPropsBooking?.truckingQuotationSelected?.sumOrtherChargeDetailForBooking?.map(
        (item, index) => ({
          key: index,
