...
export default function TuckingQuotationPOD({ dataPropsBooking }: Props) {
  ...
  useEffect(() => {
    setData(
      dataPropsBooking?.truckingQuotationPODSelected?.truckingQuotationFCLDetails?.map(
        (item, index) => ({
          key: index,
  ...
  useEffect(() => {
    setDataTotalPrice(
      dataPropsBooking?.truckingQuotationPODSelected?.sumTruckingQuotationFCLDetails?.map(
        (item, index) => ({
          key: index,
