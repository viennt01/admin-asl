...
import { FeeTable, QueryInputDraft, SelectDratSearch } from '../interface';
import { API_FEE } from '@/fetcherAxios/endpoint';
import { deleteFee, getDartTable } from '../fetcher';
import {
  DiffOutlined,
  DownloadOutlined,
  DeleteOutlined,
...
const DraftTable = ({ handleIdQuery }: PortFormProps) => {
  ...
  // Handle data
  useQuery({
    queryKey: [API_FEE.GET_SEARCH, pagination, queryInputParams],
    queryFn: () =>
      getDartTable({
        ...queryInputParams,
        ...initalValueQuerySelectParamsDraft,
